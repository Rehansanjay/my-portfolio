    ...
    >
      ...
      <div className="about__grid">
        <div className="about__text">
          ...
          <motion.p className="about__paragraph" variants={itemVariants}>
            That turned into open-source work. Seventeen of my fixes are merged upstream &mdash; ten into <strong>LiveKit Agents</strong>, plus <strong>Pipecat</strong>, <strong>jambonz</strong>, <strong>drachtio</strong> and <strong>Cosmo</strong>. One of the LiveKit changes is in its core connection pool: it was closing sockets that were still streaming, and losing handshakes that raced a settings change, which affected eleven plugins at once.
          </motion.p>
          <motion.p className="about__paragraph" variants={itemVariants}>
